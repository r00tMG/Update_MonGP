...
<template>
    <svg stroke="currentColor" class="text-success " :style="{position, top, left}" fill="currentColor" stroke-width="0" viewBox="0 0 640 512" height="3.1em" width="3.1em" xmlns="http://www.w3.org/2000/svg">
